...
const chartData = [
  { name: 'ActiveJobs', value: 71, fill: '#10b981' },
  { name: 'UnActive', value: 27, fill: '#FFD023' },
  { name: 'Closed', value: 23, fill: '#2F78EE' },
]
...
export default function TotalEmployee({ className }: { className: string }) {
  ...
  const getDataForPeriod = (period: string) => {
    switch (period) {
      case 'yearly':
        return [
          { name: 'ActiveJobs', value: 65, fill: '#10b981' },
          { name: 'UnActive', value: 32, fill: '#FFD023' },
          { name: 'Closed', value: 18, fill: '#2F78EE' },
        ]
      case 'monthly':
        return [
          { name: 'ActiveJobs', value: 45, fill: '#10b981' },
          { name: 'UnActive', value: 15, fill: '#FFD023' },
          { name: 'Closed', value: 8, fill: '#2F78EE' },
        ]
      default: // all-time
        return chartData
    }
