...
export default function EmailConfirmationPage() {
    ...
    try {
      ...
      if (result.success && result.data) {
        toast.success("OTP verified successfully!", {
          description: "Your account is now active. You can sign in to continue."
        })
        ...
        setStatus({
          loading: false,
          success: false,
          error: result.error instanceof Error ? result.error.message : "Failed to verify OTP",
          userEmail: null
        })
      }
    } catch (error) {
  ...
  if (status.success) {
    return (
      <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
        <Image src="/images/otpbg.png" alt="Onboarding Background" width={500} height={500} className="absolute top-0 left-0 w-full h-full object-cover" />
        <div className="w-full max-w-md mx-4 bg-white/95 backdrop-blur-sm rounded-lg shadow-lg p-8 text-center relative z-10">
         ...
         <Image src="/icons/success.png" alt="Success" width={265} height={140} />
         </div>
         <h2 className="text-xl font-semibold text-gray-900 mb-2">
         Email verified successfully!
         </h2>
          <p className="text-gray-600 mb-6">
          {isAutoLoggingIn ? "Automatically logging you in..." : "Email verified successfully!"}
          </p>
          ...
          <div className="flex flex-col items-center space-y-4 mb-6">
            ...
            <p className="text-sm text-gray-500">
              {isAutoLoggingIn ? "Setting up your workspace..." : "Preparing your account..."}
            </p>
          </div>
  ...
  if (status.error) {
    return (
      <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
        <Image src="/images/otpbg.png" alt="Onboarding Background" width={1000} height={1000} className="absolute top-0 left-0 w-full h-full object-cover" />
        <div className="w-full max-w-md mx-4 bg-white/95 backdrop-blur-sm rounded-lg shadow-lg p-8 text-center relative z-10">
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="w-full max-w-md mx-4 bg-white/95 backdrop-blur-sm rounded-lg shadow-lg p-8 relative z-10">
        ...
        <Image src="/logo/humanlineblack.png" alt="Success" width={100} height={100} />
         
          <h2 className="text-xl font-semibold text-gray-900">OTP Verification</h2>
          <p className="text-gray-600 text-sm">
          We have sent a verification code to email address <b>{userEmail ? userEmail : 'pristia@gmail.com'}</b>. <Link href="/signup" className="text-custom-base-green">Wrong Email?</Link> 
          </p>
        </div>
